...
export default async function FAQComponent({ locale }: { locale?: string }) {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex items-center w-full justify-end max-w-5xl mx-auto">
        <AddFaq />
      </div>
      <LinearBorder
        className="rounded-xl w-full max-w-5xl mx-auto overflow-visible"
        className2="rounded-xl relative overflow-visible"
      >
        <div className="p-5 bg-background relative rounded-xl">
          <div className="absolute w-50 aspect-square bg-primary/40 blur-[80px] -left-10 -top-30"></div>
